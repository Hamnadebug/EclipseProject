...
public class SubCategory 
{
	public static void main(String[] args)
	{
		...
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[2]/ul[1]/li[3]/div[1]/ul[1]/li[3]/a[1]")).click();//sub category
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/a[1]")).click();//add sub category
	}
